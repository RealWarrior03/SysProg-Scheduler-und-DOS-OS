...
const char * str_b = "BB";
const char * str_c = "CC";
const char * expected = "CCBB";

#define MEM_SIZE ((sizeof(mem_block)+8)*2)
MEMORY(MEM_SIZE, mem);

/* Dieser Test mach zwei Allokationen, freed dann die erste und wieder eine Allokation
 * der Platz reicht nur für zwei Allokationen
 */
